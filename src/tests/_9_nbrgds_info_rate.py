...
from NBRGDS_Interval_Tensor import NBRGDS_tensor
...
if __name__ == '__main__':
    params = {
    'data_dir': '/home/HuangRui/PointProcess/NodeGroup/data/us_death_preprocessed.npz',
    'K': 25,
    'S': 1,
    'burin': 40,
    'maxiter': 20 ,

...
include_gsl_dir = '/home/fangnan/miniconda3/include'
lib_gsl_dir = '/home/fangnan/miniconda3/lib'
...
def make_extension(ext_name, ext_path=None):
    ...
    return Extension(
        ...
        libraries=['gsl', 'gslcblas', 'cblas'],
        extra_compile_args=['-fopenmp'],
        extra_link_args=['-fopenmp', '-Wl,-rpath=/root/miniconda3/lib']
    )
